package com.kr.co.bootpay.javaApache;

import com.fasterxml.jackson.databind.util.JSONPObject;
import com.google.gson.Gson;
import com.kr.co.bootpay.javaApache.model.request.*;
import com.kr.co.bootpay.javaApache.model.response.ResToken;
...
//    private final String URL_NAVERPAY_ITEM_RESPONSE = BASE_URL + "npay/product.json";
    ...
    public String getAccessToken() throws Exception {
        ...
        System.out.println(">>>>>>>>>>>>>>"+URL_ACCESS_TOKEN+" // "+new Gson().toJson(token));
		...
		{
        	System.out.println(">>>>>>>>>>>"+String.valueOf(resToken.status));
		}

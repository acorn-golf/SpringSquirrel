...
@Alias("PickOrderListDTO")
public class PickOrderListDTO {
	...
	public PickOrderListDTO() {
		// TODO Auto-generated constructor stub
	}
	
	public PickOrderListDTO(String cc_name, String cc_img, int pick_no, String p_id, String p_pdate, String p_uploaddate,
			int p_maxpeople, int pick_amount, int p_hole, String p_caddyyn, String p_babyn, String p_cartyn, int p_price,
